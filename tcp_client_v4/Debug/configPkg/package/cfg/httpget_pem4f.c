...
__T1_ti_sysbios_knl_Mailbox_Instance_State__allocBuf ti_sysbios_knl_Mailbox_Instance_State_0_allocBuf__A[240];
#ifdef __ti__align
    #pragma DATA_ALIGN(ti_sysbios_knl_Mailbox_Instance_State_0_allocBuf__A, 8);
#endif
#ifdef __GNUC__
#ifndef __TI_COMPILER_VERSION__
__T1_ti_sysbios_knl_Mailbox_Instance_State__allocBuf ti_sysbios_knl_Mailbox_Instance_State_0_allocBuf__A[240] __attribute__ ((aligned(8)));
#endif
#endif
#ifdef __IAR_SYSTEMS_ICC__
    #pragma data_alignment=8
...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6506];
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/islam/workspace_v10/tcp_client_v4/Debug/configPkg/package/cfg/httpget_pem4f");
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x196a;
...
{
    return (void *)&ti_sysbios_hal_CacheNull_Module__FXNS__C;
}
